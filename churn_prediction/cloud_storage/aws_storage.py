...
from churn_prediction.configuration.aws_connection import S3Client
...
class StorageService:
    ...
    def s3_key_path(self,bucket_name,s3_key)-> bool:
        try:
    ...
    def get_file_object(self, filename: str, bucket_name: str) -> Union[List[object], object]:
        ...
        Description: This method gets the file_object from bucket_name bucket based on filename 
